...
final class CampaignService {
	...
	private function sanitize( array $campaign ): array {
		...
		return array(
			...
			'priority'   => sanitize_text_field( (string) ( $campaign['priority'] ?? 10 ) ),
	...
	private function validate( array $campaign ): array {
		...
		if (
			! is_numeric( $campaign['priority'] ) ||
			(int) $campaign['priority'] < 0 ||
			(string) (int) $campaign['priority'] !== (string) $campaign['priority']
		) {
